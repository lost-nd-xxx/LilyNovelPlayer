...
* [LilyNovelPlayer全体についてのライセンス](#LilyNovelPlayer全体についてのライセンス)
* [同梱素材のリストと利用条件](#同梱素材のリストと利用条件)
* [使用素材とそのライセンスまとめ](#使用素材とそのライセンスまとめ)


## LilyNovelPlayer全体についてのライセンス
MITライセンスを適用します。

| (c)2026 lost_nd_xxx & omochi-yoichi<br>Released under the MIT license<br>https://opensource.org/license/MIT |
| :- |


## 同梱素材のリストと利用条件
### 利用条件
[同梱素材リスト](#同梱素材リスト)に含まれるファイルについては、LNPへに関する物品の制作＆頒布時に限り、以下の条件でご自由にお使いいただけます。
* 著作者表示不要
* 加筆・反転等の加工OK
* 同梱再配布OK
